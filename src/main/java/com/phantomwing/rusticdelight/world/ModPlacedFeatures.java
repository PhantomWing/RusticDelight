...
public class ModPlacedFeatures {
    ...
    private static void registerWildCrops(BootstapContext<PlacedFeature> context) {
        ...
        registerWildCrop(context, configuredFeatures, BELL_PEPPER_BLOCK_PATCH_PLACED_KEY, ModConfiguredFeatures.BELL_PEPPER_BLOCK_PATCH_KEY, Configuration.CHANCE_BELL_PEPPER_BLOCK_PATCH_ID);
    }

    private static void registerWildCrop(BootstapContext<PlacedFeature> context, HolderGetter<ConfiguredFeature<?, ?>> configuredFeatures, ResourceKey<PlacedFeature> placedFeatureKey, ResourceKey<ConfiguredFeature<?, ?>> configuredFeatureKey, String configuredChanceId) {
