...
public class ModVillageStructures {
    ...
    public static void addVillageCrops(ServerAboutToStartEvent event) {
        ...
        addProcessor(registry, new ResourceLocation("farm_plains"), plains);
        addProcessor(registry, new ResourceLocation("farm_taiga"), taiga);
        addProcessor(registry, new ResourceLocation("farm_savanna"), savanna);
        addProcessor(registry, new ResourceLocation("farm_desert"), desert);
    }
    ...
    private static void addProcessor(Registry<StructureProcessorList> registry, ResourceLocation id, List<ProcessorRule> rules) {
        if (rules.isEmpty()) {
            return;
        }
