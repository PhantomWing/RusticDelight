...
public class ModConfiguredFeatures {
    ...
    private static void registerWildCrops(BootstrapContext<ConfiguredFeature<?, ?>> context) {
        registerFlowerPatch(context, WILD_COTTON_KEY, ModBlocks.WILD_COTTON, 32, 6, 4);
        registerFlowerPatch(context, WILD_BELL_PEPPERS_KEY, ModBlocks.WILD_BELL_PEPPERS, 48, 4, 4);
        registerFlowerPatch(context, WILD_COFFEE_KEY, ModBlocks.WILD_COFFEE, 48, 6, 4);
    }
