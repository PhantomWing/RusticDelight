...
public class ModConfiguredFeatures {
    ...
    private static void registerWildCrops(BootstrapContext<ConfiguredFeature<?, ?>> context) {
        ...
        registerWildCropPatch(context, WILD_COTTON_KEY, BlockStateProvider.simple(ModBlocks.WILD_COTTON), Blocks.SHORT_GRASS);
        ...
        registerWildCropPatch(context, WILD_COFFEE_KEY, BlockStateProvider.simple(ModBlocks.WILD_COFFEE), Blocks.FERN);
    }
     ...
     */
    private static void registerWildCropPatch(BootstrapContext<ConfiguredFeature<?, ?>> context, ResourceKey<ConfiguredFeature<?, ?>> key, BlockStateProvider cropProvider, Block ambianceBlock) {
