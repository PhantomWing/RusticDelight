...
public class ModVillagerTrades extends FabricDynamicRegistryProvider {
    ...
    protected void configure(HolderLookup.Provider registries, Entries entries) {
        ...
        // Fisherman level 1: 1 emerald + 6 raw calamari -> 6 cooked calamari
        addVillagerTrade(entries, FISHERMAN_1_COOKED_CALAMARI, compoundTrade(Items.EMERALD, 1, ModItems.CALAMARI, 6, ModItems.COOKED_CALAMARI, 6, 16, 1), calamariEnabled);
