    ...
    protected @NotNull RecipeProvider createRecipeProvider(HolderLookup.@NotNull Provider registryLookup, @NotNull RecipeOutput exporter) {
        return new RecipeProvider(registryLookup, exporter) {
            ...
            private void buildCraftingRecipes(@NotNull RecipeOutput output) {
                ...
                // Pies
                pieRecipes(output, ModItems.SYRUP_CHEESECAKE, ModItems.SYRUP_CHEESECAKE_SLICE, tagIngredient(ModTags.Items.SYRUP));
                pieRecipes(output, ModItems.CHERRY_BLOSSOM_CHEESECAKE, ModItems.CHERRY_BLOSSOM_CHEESECAKE_SLICE, tagIngredient(ModTags.Items.CHERRY_BLOSSOM_INGREDIENTS));

                // Pancakes
                pancakeRecipes(output, ModItems.PANCAKES, ModItems.PANCAKE, tagIngredient(ModTags.Items.SYRUP), Ingredient.of(Items.SUGAR));
                ...
                pancakeRecipes(output, ModItems.CHOCOLATE_PANCAKES, ModItems.CHOCOLATE_PANCAKE, tagIngredient(CommonTags.FOODS_MILK), Ingredient.of(Items.COCOA_BEANS));
                pancakeRecipes(output, ModItems.VEGETABLE_PANCAKES, ModItems.VEGETABLE_PANCAKE, tagIngredient(CommonTags.FOODS_MILK), tagIngredient(ConventionalItemTags.VEGETABLE_FOODS), tagIngredient(CommonTags.FOODS_LEAFY_GREEN));
                pancakeRecipes(output, ModItems.CHERRY_BLOSSOM_PANCAKES, ModItems.CHERRY_BLOSSOM_PANCAKE, tagIngredient(CommonTags.FOODS_MILK), tagIngredient(ModTags.Items.CHERRY_BLOSSOM_INGREDIENTS));
                pancakeRecipes(output, ModItems.PUMPKIN_PANCAKES, ModItems.PUMPKIN_PANCAKE, tagIngredient(ModTags.Items.SYRUP), Ingredient.of(vectorwing.farmersdelight.common.registry.ModItems.PUMPKIN_SLICE.get()));
            ...
            private void pieRecipes(@NotNull RecipeOutput recipeOutput, @NotNull Item pieBlock, @NotNull Item sliceItem, Ingredient topping) {
