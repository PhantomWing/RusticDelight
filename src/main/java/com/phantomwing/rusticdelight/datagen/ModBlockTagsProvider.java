...
public class ModBlockTagsProvider extends FabricTagProvider.BlockTagProvider {
    ...
    private void addModTags() {
        this.getOrCreateTagBuilder(ModTags.Blocks.PANCAKES).add(
                ModBlocks.PANCAKES,
    ...
    private void addCommonTags() {
        ...
        this.getOrCreateTagBuilder(CommonTags.STORAGE_BLOCKS_PALE_BELL_PEPPER_SEEDS).add(
                ModBlocks.PALE_BELL_PEPPER_SEEDS_BAG
        );
        this.getOrCreateTagBuilder(CommonTags.STORAGE_BLOCKS_DARK_BELL_PEPPER_SEEDS).add(
        ...
        this.getOrCreateTagBuilder(CommonTags.STORAGE_BLOCKS_BELL_PEPPER_ORANGE).add(
                ModBlocks.BELL_PEPPER_ORANGE_CRATE
        );
        this.getOrCreateTagBuilder(CommonTags.STORAGE_BLOCKS_BELL_PEPPER_WHITE).add(
                ModBlocks.BELL_PEPPER_WHITE_CRATE
        );
        this.getOrCreateTagBuilder(CommonTags.STORAGE_BLOCKS_BELL_PEPPER_PINK).add(
                ModBlocks.BELL_PEPPER_PINK_CRATE
        );
        this.getOrCreateTagBuilder(CommonTags.STORAGE_BLOCKS_BELL_PEPPER_BLUE).add(
                ModBlocks.BELL_PEPPER_BLUE_CRATE
        );
        this.getOrCreateTagBuilder(CommonTags.STORAGE_BLOCKS_BELL_PEPPER_PURPLE).add(
                ModBlocks.BELL_PEPPER_PURPLE_CRATE
        );
        this.getOrCreateTagBuilder(CommonTags.STORAGE_BLOCKS_BELL_PEPPER_BLACK).add(
                ModBlocks.BELL_PEPPER_BLACK_CRATE
        );
        this.getOrCreateTagBuilder(CommonTags.STORAGE_BLOCKS_CALAMARI).add(
                ModBlocks.CALAMARI_CRATE
        );
    ...
    private void addCompatibilityTags() {
        // Farmers Delight
        this.getOrCreateTagBuilder(vectorwing.farmersdelight.common.tag.ModTags.Blocks.STRAW_BLOCKS).add(
                ModBlocks.COTTON_SEEDS_BAG,
                ModBlocks.BELL_PEPPER_SEEDS_BAG,
                ModBlocks.PALE_BELL_PEPPER_SEEDS_BAG,
                ModBlocks.DARK_BELL_PEPPER_SEEDS_BAG,
        ...
        this.getOrCreateTagBuilder(vectorwing.farmersdelight.common.tag.ModTags.Blocks.WILD_CROPS).add(
                ModBlocks.WILD_COTTON,
                ModBlocks.WILD_BELL_PEPPERS,
                ModBlocks.WILD_PALE_BELL_PEPPERS,
                ModBlocks.WILD_DARK_BELL_PEPPERS,
