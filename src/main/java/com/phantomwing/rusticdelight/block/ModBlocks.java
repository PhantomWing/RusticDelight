...
public class ModBlocks {
    ...
    public static final Block PALE_BELL_PEPPER_SEEDS_BAG = registerBlock("pale_bell_pepper_seeds_bag", Blocks.WHITE_WOOL, Block::new);
    public static final Block DARK_BELL_PEPPER_SEEDS_BAG = registerBlock("dark_bell_pepper_seeds_bag", Blocks.WHITE_WOOL, Block::new);
