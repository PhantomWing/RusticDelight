...
public class ModItems {
    ...
    public static final Item PALE_BELL_PEPPER_SEEDS = registerWithTab("pale_bell_pepper_seeds", new ItemNameBlockItem(
            ModBlocks.PALE_BELL_PEPPER_CROP,
            baseItem()), ItemFamily.BELL_PEPPER);
    public static final Item DARK_BELL_PEPPER_SEEDS = registerWithTab("dark_bell_pepper_seeds", new ItemNameBlockItem(
    ...
    public static Item registerWithTab(final String name, final Item item, final ItemFamily... families) {
        Item registered = Registry.register(BuiltInRegistries.ITEM, ResourceLocation.fromNamespaceAndPath(RusticDelight.MOD_ID, name), item);
        CREATIVE_TAB_ITEMS.put(registered, families);
        return registered;
    }

    public static Item registerBlockWithTab(Block block, ItemFamily... families) {
        return registerWithTab(BuiltInRegistries.BLOCK.getKey(block).getPath(), new BlockItem(block, new Item.Properties()), families);
    }

    public static Item registerBlockWithTab(Block block, Item.Properties properties) {
        return registerWithTab(BuiltInRegistries.BLOCK.getKey(block).getPath(), new BlockItem(block, properties));
    }

    public static Item registerPlaceableBlockWithTab(Block block, Item.Properties properties, ItemFamily... families) {
        return registerWithTab(BuiltInRegistries.BLOCK.getKey(block).getPath(), new PlaceableItem(block, properties), families);
    }
